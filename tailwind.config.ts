...
export default {
  darkMode: ["class"],
  content: ["./index.tsx", "./pages/**/*.{ts,tsx}", "./components/**/*.{ts,tsx}", "./app/**/*.{ts,tsx}", "./src/**/*.{ts,tsx}"],
  prefix: "",
  theme: {
    container: {
      center: true,
    ...
    extend: {
      ...
      colors: {
        ...
        clock: {
          bg: "hsl(var(--clock-bg))",
          dial: "hsl(var(--clock-dial-bg))",
          number: "hsl(var(--clock-number))",
          "number-selected": "hsl(var(--clock-number-selected))",
        ...
        resume: {
          ...
          card: "hsl(var(--resume-card))",
          "card-foreground": "hsl(var(--resume-card-foreground))",
          ...
          "skill-bg": "hsl(var(--resume-skill-bg))",
        },
      },
      boxShadow: {
